...
function! vimonga#repo#index#list(collection) abort
    ...
    return vimonga#repo#impl#execute(conn, ['index', db, coll, 'list'])
endfunction
...
function! vimonga#repo#index#create(collection, content) abort
    ...
    return vimonga#repo#impl#execute(conn, ['index', db, coll, 'create', keys])
endfunction
...
function! vimonga#repo#index#drop(index) abort
    ...
    return vimonga#repo#impl#execute(conn, ['index', db, coll, 'drop', name])
endfunction
